        ...
        <div class="splitArea">
            ...
            <div class="left">
                ...
                <div class="galerie galsplit">
                    <div class="titlee">
                        <h2 class="title">
                            <i class='bx bxs-video-recording'></i> Videos
                        </h2>
                    </div>
            ...
            <script>
                ...
                function seeMoreGalerie() {
                    ...
                    xhr.open('GET', 'src/php/load_more_vids.php?<?= isset($_GET['dir']) ? 'dir=' . $_GET['dir'] . '&' : '' ?>offset=' + offset, true);
                    xhr.onload = function() {
                        if (xhr.status === 200) {
